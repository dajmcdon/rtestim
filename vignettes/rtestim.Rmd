...
penalty $\lambda$, if no $\lambda$ is provided, is calculated internally based 
on case counts.
...
Users may wish to visualize the $\Rtseq$ which minimizes the cross-validation 
